import {defaults} from 'locomotive-scroll/src/scripts/options';
import Scroll from 'locomotive-scroll/src/scripts/Native';
...
export default class {
    ...
    init() {
        ...
        //remove default trigger window location hash
