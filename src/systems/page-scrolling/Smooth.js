...
import Core from 'locomotive-scroll/src/scripts/Core';
import {lerp} from 'locomotive-scroll/src/scripts/utils/maths'
import {getTranslate} from 'locomotive-scroll/src/scripts/utils/transform'
import {getParents, queryClosestParent} from 'locomotive-scroll/src/scripts/utils/html';
import BezierEasing from 'bezier-easing';
//import HTHelper from "../../../libs/helper";
...
export default class extends Core {
    ...
    addSections() {
        ...
        sections.forEach((section, i) => {
            let offset = section.getBoundingClientRect().top - (window.innerHeight * 2) - getTranslate(section).y;
